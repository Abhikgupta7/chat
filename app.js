...
},
{
    ...
    location: 'USA',
    pid: '60C3350',
    summary: "I am gay, telling you in advance because people usually leave the chat after knowing this and I don't want to hide it. If you are open to talking to a gay guy, then you are most welcome. Beside that I work in finance sector, loves to play baseball. And currently, 21 Pilots are my stress buster. See ya."
}]
...
let female = [
    {
        ...
        location: 'India',
        pid: '69P2976',
        summary: "A night owl. Sleeps in day and work at night. Dark circles are my only friends. I am open to add new friends to my group"
    },
    {
        name: 'Katrin',
        age: '23',
...
app.post("/skipUser", async (req, res) => {
    ...
    if (!user_map.has(req.body.userId)) {
        ...
        var status = '';
        if (receiver_id.pid === '68X3255' || receiver_id.pid === '60G3350' || receiver_id.pid === '60G3350' || receiver_id.pid === '68Y3255' || receiver_id.pid === '41Z3069' || receiver_id.pid === '20T3162' || receiver_id.pid === '35O2883') status = 'decline'
        res.status(200).json({
            success: true,
            receiver_id,
